package com.mydes.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.mydes.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.mydes.springboot.model" });
